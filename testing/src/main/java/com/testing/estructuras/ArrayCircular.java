...
public class ArrayCircular<E extends Comparable<E>> {
    ...
    public void addBefore(int index, E element) {
        ...
        int actualIndex = (head + index) % capacity; // se obtiene el índice real del elemento en el arreglo
        // se mueven los elementos a la derecha del índice para hacer espacio al nuevo
        // elemento
    ...
    public E popBack() {
        ...
        data[tail] = null; // se elimina la referencia al último elemento para permitir la recolección de
                           // basura
    ...
    public E popFront() {
        ...
        data[head] = null; // se elimina la referencia al primer elemento para permitir la recolección de
                           // basura
    ...
    // devuelve el indice si no encontro el elmento, si lo encontro devuelve -1(no
    // es necesario devolver mid para este problema)
