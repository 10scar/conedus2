...
public class DoubleLinkedList {
    ...
    /**
     * Deletes the passed Link from the current list
     *
     * @param z Element to be deleted
     */
    public void deleteLink(Link z) {
        if (z.next == null) {
            deleteTail();
        } else if (z == head) {
            deleteHead();
    ...
    public void removeDuplicates(DoubleLinkedList l) {
        Link linkOne = l.getHead();
    ...
    private Link quickSortUtil(Link Link) {
        ...
        Link left = quickSortUtil(Link);
        Link right = quickSortUtil(pivot.next);
