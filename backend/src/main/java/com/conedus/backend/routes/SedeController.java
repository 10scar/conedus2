...
public class SedeController {
    ...
    public String actualizarSede() {
        String sql = "UPDATE sedes WHERE id = 0";
        return "";
    }
    ...
    public ArbolAVL<Sede> get_data() {
        ...
        for (Map<String, Object> fila : resultados) {
            ...
            // String sql_pro = "SELECT sum(icfes_global)/count(*) as pro FROM
            // ouvxvkkq_conedus_pruebas.icfes where sedes_id=1 group by sedes_id";
            // List<Map<String, Object>> resultados_pro =
            // jdbcTemplate.queryForList(sql_pro);
